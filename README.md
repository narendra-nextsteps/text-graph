...
## Development environment and release process
 ...
 - create virtualenv with Flask and graph_curation installed into it (latter is installed in
...
install it (`pip install graph_curation.tar.gz`), ensure that configuration file exists and
`GRAPH_CURATION_SETTINGS` environment variable points to it, ensure that user has access to the
